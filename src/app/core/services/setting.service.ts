...
import { LocalStorageService } from 'src/app/shared/services/utilities/local-storage.service';
import { DirectionalityService } from 'src/app/shared/services/utilities/directionality.service';

import { AppSettings, AppTheme, defaults } from '../constants/setting';
...
export class SettingsService {
  ...
  constructor(
    ...
    @Inject(Directionality) public dir: DirectionalityService
  ) {
