...
// @Component({
//   selector: 'app-list-test-exam',
//   templateUrl: './list-test-exam.component.html',
//   styleUrls: ['./list-test-exam.component.css']
// })
// export class ListTestExamComponent {
...
export class ListTestExamComponent {
  ...
  ngOnInit() {
    ...
    // console.log(this.userCurrent.groupModuleIds);
  ...
  // request.groupModuleIds.forEach((id:any) => {
  //   params = params.append('groupModuleIds', id.toString());
  // });
